...
ActiveRecord::Schema.define(version: 2019_02_22_112022) do
  ...
  create_table "bookings", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id"
    t.bigint "animation_id"
    t.boolean "status"
    t.index ["animation_id"], name: "index_bookings_on_animation_id"
  ...
  add_foreign_key "bookings", "animations"
